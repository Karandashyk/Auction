...
class DealsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create deal" do
    assert_difference('Deal.count') do
      post deals_url, params: { deal: { consumer_id: @deal.consumer_id, price: @deal.price, product_id: @deal.product_id, state: @deal.state } }
    end
  ...
  test "should update deal" do
    patch deal_url(@deal), params: { deal: { consumer_id: @deal.consumer_id, price: @deal.price, product_id: @deal.product_id, state: @deal.state } }
