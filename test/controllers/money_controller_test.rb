...
class MoneyControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create money" do
    assert_difference('Money.count') do
      post money_index_url, params: { money: { reserved_sum: @money.reserved_sum, total_sum: @money.total_sum } }
    end
  ...
  test "should update money" do
    patch money_url(@money), params: { money: { reserved_sum: @money.reserved_sum, total_sum: @money.total_sum } }
